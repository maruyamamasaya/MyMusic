...
nonisolated struct VisualWorldUniforms: Equatable {
    ...
    var plasma1 = SIMD4<Float>(repeating: 0)
    var plasma2 = SIMD4<Float>(repeating: 0)
    var plasma3 = SIMD4<Float>(repeating: 0)
    var plasma4 = SIMD4<Float>(repeating: 0)
    var plasmaBranch0 = SIMD4<Float>(repeating: 0)
    var plasmaBranch1 = SIMD4<Float>(repeating: 0)
    var plasmaBranch2 = SIMD4<Float>(repeating: 0)
    var plasmaBranch3 = SIMD4<Float>(repeating: 0)
    var plasmaBranch4 = SIMD4<Float>(repeating: 0)
