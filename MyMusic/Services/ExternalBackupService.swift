...
nonisolated final class ExternalBackupService: @unchecked Sendable {
    ...
    private let settingsKeys = [
        ...
        "appearance.theme", "appearance.visualWorldStyle", "volumeNormalizationEnabled", "sourceSampleRateMatchingEnabled", "library.disabledGenreNames", "library.genreDisplayPresets",
